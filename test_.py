...
def test_sha256_standard_init():
    ...
    assert (
        _hash._hash.hash
        == "f9ca496861aeb0266ed5d5637513b1a778ba33f4b8f5eb00ef08ba98be7e3bba"
    )
...
def test_sha256_password_changing():
    ...
    assert (
        _hash._hash.hash
        == "f0bf9986cd9df3d8f4f9823a2bf1890d171ea05d0c36c593213a94e528dbef5b"
    )
    assert _hash._hash.salt == "salt"
